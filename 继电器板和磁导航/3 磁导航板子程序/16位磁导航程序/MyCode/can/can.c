...
//	CAN_FilterInitStructure.CAN_FilterMaskIdHigh=0x00;//32Î»MASK£¬Îª1¼´Ñ¡ÖĞ¸ÃÎ»£¬Ñ¡ÖĞ11Î»ID
//	CAN_FilterInitStructure.CAN_FilterMaskIdLow=0x0006;//Ñ¡ÖĞ±ê×¼Ò£¿ØÖ¡
	CAN_FilterInitStructure.CAN_FilterIdHigh=0x0000;	//32Î»ID£¬±ê×¼Ö¡IDÎª11Î»£¬IDÎª0x10Ê±£¬¶ş½øÖÆ00010000£¬²¹È«11Î»Îª00000010000£¬¶ÔÓ¦Ê®Áù½øÖÆÎª0x0200.
	CAN_FilterInitStructure.CAN_FilterIdLow=0x0000;		//ÉèÖÃ½ÓÊÕµÄÎª±ê×¼Ò£¿Ø£¨Ô¶³Ì£©Ö¡£¬
	CAN_FilterInitStructure.CAN_FilterMaskIdHigh=0x0000;//32Î»MASK£¬Îª1¼´Ñ¡ÖĞ¸ÃÎ»£¬Ñ¡ÖĞ11Î»ID
	CAN_FilterInitStructure.CAN_FilterMaskIdLow=0x0000;//Ñ¡ÖĞ±ê×¼Ò£¿ØÖ¡
...
u8 cansend[2]={0xff,0xff};
void send(void)
{
//	u16 temp[2],i=0;
	cansend[1]=IN0|IN1<<1|IN2<<2|IN3<<3|IN4<<4|IN5<<5|IN6<<6|IN7<<7;
	cansend[0]=IN8|IN9<<1|IN10<<2|IN11<<3|IN12<<4|IN13<<5|IN14<<6|IN15<<7;
	Can_Send_Msg(cansend,2);
	
//	temp[1]=IN0|IN1<<1|IN2<<2|IN3<<3|IN4<<4|IN5<<5|IN6<<6|IN7<<7;
//	temp[0]=IN8|IN9<<1|IN10<<2|IN11<<3|IN12<<4|IN13<<5|IN14<<6|IN15<<7;
//	if(!((temp[0]==cansend[0])&&(temp[1]==cansend[1])))
//	{
//		cansend[0]=temp[0];
//		cansend[1]=temp[1];
//		Can_Send_Msg(cansend,2);
